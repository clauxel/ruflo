...
export const modelCatalog: FrontendCatalogOption[] = [
  {
    ...
    highlights: ['Default', 'Latest OpenAI'],
  },
  {
    id: 'claude-sonnet-4-6',
    name: 'Claude Sonnet 4.6',
    status: 'Claude Code',
    highlights: ['Claude Code', 'Fast orchestration'],
  },
  {
    id: 'gemini-3-1-pro',
    name: 'Gemini 3.1 Pro',
    status: 'Planner',
    highlights: ['Long context', 'Research'],
  },
  {
    id: 'claude-opus-4-6',
...
export const channelCatalog: FrontendCatalogOption[] = [
  {
    ...
    name: 'Claude Code',
    status: 'Live',
    highlights: ['Plugin path'],
  },
  {
    id: 'discord',
    name: 'Codex',
    status: 'Live',
    highlights: ['Repo workflows'],
  },
  {
    id: 'whatsapp',
    name: 'Ruflo UI',
    status: 'Live',
    highlights: ['Hosted console'],
  },
]
